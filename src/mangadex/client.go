...
func NewMangadexClient(url string) *MangaDexClient {
...
func (client *MangaDexClient) newRequest(method, path string, headers http.Header, params url.Values) (*http.Request, error) {
	if params == nil {
		params = url.Values{}
	}
...
func (client *MangaDexClient) do(req *http.Request, v interface{}) error {
	var (
		err     error
		resp    *http.Response
		retries = 3
